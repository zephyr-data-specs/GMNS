...
| <span class="underline">coord_ref_to</span> | INTEGER         | Optional  | For coordinated signals, the part of the phase where coordination starts: begin_of_green, begin_of_yellow, begin_of_red |
